  ...
  tabsetPanel( 
    ...
    tabPanel("Overview",icon=icon("fas fa-globe"),
           fluidPage(
             ...
             fluidRow(column(width =11, h3("There are several factors that that can increase the risk for stroke, includes age, sex, unhealthy eating habits and smoking. 
                                           We will be using dataset 'Stroke prediction dataset' from Kaggle to study the stroke attributes"))),
            ...
            tabPanel("Data Explorer",icon=icon("fas fa-search"),
              ...
              tabPanel("Documentation", icon=icon("fas fa-file-alt"),
                ...
                # ------------- App: Source Code -------------------------
                tabPanel("Source Code", icon=icon("fas fa-file-code"), href = "https://github.com/amandaheng/dengueshinyproject")
